...
## Observations
- Most did one or two prompts
- Some people did not include an intro or conclusion
- Most people included last names, is that a privacy problem?
- Some people included the boilerplate, which should have been removed
...
## Other news
Let's look at Data Points and The Batch

## Last year's news in week three: Deepseek R1
...
- Compare it to a manually-generated bibliography from the ACM digital library
- The subject is PDF remediation: the process of making a PDF accessible to people with disabilities
- Most of the literature is about research papers students are required to read
- I'm familiar with this literature, making it easier for me to detect hallucinations and judge the importance of the papers listed
- A recent bibliography in this area listed 39 sources, of which only about 20 were relevant
- Document your process!

## Details
- Turn in a .qmd file and an .html file and a .bib file
- Respect the file naming convention: eB.qmd, eB.html, eB.bib
- Use the template file in Canvas > Files > hw
