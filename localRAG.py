...
from langchain_community.vectorstores import Chroma  # ← 여기서도 변경됨!
import gradio as gr
import re
...
# Ensure OPENAI_API_KEY is set in your environment, or uncomment and set below:
# os.environ["OPENAI_API_KEY"] = "sk-..."

# Use OpenAI API-based embeddings (you can switch to "text-embedding-3-small" to save cost)
...
def retrieve_context(question):
    results = retriever.invoke(question)  # ✅ 올바른 방식
...
# %%
interface.close()  # Close the Gradio
