...
- The Batch (from deeplearning.ai)
- Data Points (from deeplearning.ai)
...
## More on effect size from Claude Sonnet 4.5
  ...
  - $R²$: Proportion of variance explained (0 to 1)
    - Example: $R²$ = 0.25 means the model explains 25% of variance
  - Odds ratio: Likelihood ratio for categorical outcomes
    - OR = 1 (no effect), OR > 1 (increased odds), OR < 1 (decreased odds)

## Still more on effect size from Claude Sonnet 4.5
-  Example:
-  A drug lowers blood pressure by 2 mmHg ($p = 0.001$, $d = 0.15$). It's statistically significant but the effect size is small - clinically unimportant despite the low $p$-value.

-  Effect sizes help you answer: "Is this difference large enough to care about?"
...
- m1 involves group identity and project focus, e.g., a chatbot's purpose
- It's smart to pick a domain for m1 for which you can generate some labeled data
- m2 will involve generating labeled data, assuming you plan a RAG chatbot
