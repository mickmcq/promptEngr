...
The following chunk should NOT be run in this document. Run it in a terminal. You may render this document multiple times but you should only install Haystack once.
